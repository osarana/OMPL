...
int main()
{
    // plan for 2 rigid bodies in R3SO2
    app::R3SO2MultiRigidBodyPlanning setup(2);
    ...
    auto *start1 = start->as<base::R3SO2StateSpace::StateType>(0);
    ...
    auto *goal1 = goal->as<base::R3SO2StateSpace::StateType>(0);
    goal1->setX(200.49);
    goal1->setY(-40.62);
    goal1->setZ(70.57);
    goal1->setYaw(0.0);

    auto *start2 = start->as<base::R3SO2StateSpace::StateType>(1);
    ...
    auto *goal2 = goal->as<base::R3SO2StateSpace::StateType>(1);
    goal2->setX(-4.96);
    goal2->setY(-40.62);
    goal2->setZ(70.57);
    goal2->setYaw(0.0);
