...
void configureApartmentProblem(app::R3SO2RigidBodyPlanning &setup)
{
    ...
    base::ScopedState<base::R3SO2StateSpace> goal(setup.getSpaceInformation());
    goal->setX(140.0);
    goal->setY(0.0);
    goal->setZ(36.46);
    goal->setYaw(0.0);
    ...
    setup.getSpaceInformation()->getStateSpace()->as<base::R3SO2StateSpace>()->setBounds(bounds);
}

void configureEasyProblem(app::R3SO2RigidBodyPlanning &setup)
{
...
void configureCubiclesProblem(app::R3SO2RigidBodyPlanning &setup)
{
